                            ...
                            @foreach($banners as $key => $banner)
                                @if($key == 0)
                                    <div class="item active">
                                        <a href="{{$banner->link}}"><img src="{{\App\Helpers\Helpers::banner_asset($banner->image)}}"></a>
                                    </div>
                                @else
                                    <div class="item">
                                        <a href="{{$banner->link}}"><img src="{{\App\Helpers\Helpers::banner_asset($banner->image)}}"></a>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="{{\App\Helpers\Helpers::product_small_image_asset($product->product_image)}}" alt="" />
                                        <h2>${{$product->price}}</h2>
                                        <p>{{$product->product_name}}</p>
                                        <a href="{{route('product',['id'=>$product->id])}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                    </div>
                                </div>
                                <div class="choose">
